...
3. `verda/setup_pixi_env.sh` adds Pixi/COLMAP paths and CUDA build variables.
   It sets multi-architecture CUDA extension build targets for Tesla V100 /
   Volta (`7.0`), RTX A6000 / Ampere (`8.6`), and RTX 6000 Ada / Ada (`8.9`):
   `TCNN_CUDA_ARCHITECTURES=70;86;89` and `TORCH_CUDA_ARCH_LIST=7.0;8.6;8.9`.
